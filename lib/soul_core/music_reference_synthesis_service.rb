  ...
  class MusicReferenceSynthesisService
    ...
    def validate_response(value, references)
      ...
      result = {
        ...
        "caption" => bounded_text(value["caption"], "Sound and Structure", 8_000),
