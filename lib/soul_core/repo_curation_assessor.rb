  ...
  class RepoCurationAssessor
    ...
    def assess
...

      {
        ...
        "proposed_actions" => proposed_actions(tracked_overlay_notes, untracked_review_candidates, untracked_generated_local),
        "verification" => {
          "read_only" => true,
    ...
    def proposed_actions(tracked_overlay_notes, untracked_review_candidates, untracked_generated_local)
      actions = []
