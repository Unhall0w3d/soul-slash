...
module SoulCore
  module ApplicationContract
    ...
    OPERATIONS = {
      ...
      "maintenance.discovery.enroll.preview" => %w[address label mode ssh_alias],
      "maintenance.discovery.enroll.execute" => %w[address label mode ssh_alias confirmation expected_digest],
