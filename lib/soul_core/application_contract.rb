...
module SoulCore
  module ApplicationContract
    ...
    OPERATIONS = {
      ...
      "visual.blender.preview" => %w[visual_project_id project_id candidate_id template_id bars direction seed quality look_profile source_blender_scene_id],
      "visual.blender.execute" => %w[visual_project_id blender_scene_id project_id candidate_id template_id bars direction seed quality look_profile source_blender_scene_id confirmation expected_digest],
