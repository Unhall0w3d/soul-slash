...
- **Visual Studio** provides bounded local FLUX.2 Vulkan still generation, review, guided image edits, Wan 2.2 image-guided motion, FastWan 2.2 native text-to-video, and a candidate Blender 5.2 EEVEE lane for editable audio-reactive whole-bar procedural scenes. All lanes preserve immutable revision lineage, candidate/project deletion boundaries, and exact Music-candidate binding.
