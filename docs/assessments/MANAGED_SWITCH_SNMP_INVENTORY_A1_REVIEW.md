...
- [ ] Lattice live poll proves installed firmware and interface evidence.
- [x] Configured Loom community remains absent from argv, output, evidence,
  logs, and Git; `.env` remains ignored and untracked.
