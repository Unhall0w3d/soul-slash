...
.PHONY: memory-retrieval-evaluate memory-retrieval-evaluate-live memory-retrieval-status memory-retrieval-rebuild memory-retrieval-query memory-reviewed-ledger-preview memory-reviewed-ledger-execute memory-embedding-runtime-plan memory-embedding-runtime-install memory-embedding-runtime-status memory-live-status memory-live-derive memory-live-admit memory-live-retrieve memory-live-rollback memory-backfill-preview memory-backfill-execute memory-lifecycle-cycle verify-memory-retrieval-observatory verify-semantic-memory-chat-context verify-memory-runtime-private-review verify-memory-reviewed-ledger-bootstrap verify-memory-embedding-core-lifecycle verify-memory-audit-reconstruction verify-memory-conversation-observation-capture verify-memory-observation-derivation verify-memory-lifecycle-admission verify-memory-live-qualification verify-memory-historical-chat-backfill verify-memory-autonomous-lifecycle verify-core-transition-settlement
