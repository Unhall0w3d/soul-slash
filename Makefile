...
.PHONY: memory-retrieval-evaluate memory-retrieval-evaluate-live memory-retrieval-status memory-retrieval-rebuild memory-retrieval-query memory-reviewed-ledger-preview memory-reviewed-ledger-execute verify-memory-retrieval-observatory verify-semantic-memory-chat-context verify-memory-runtime-private-review verify-memory-reviewed-ledger-bootstrap
