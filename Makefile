...
.PHONY: memory-retrieval-evaluate memory-retrieval-evaluate-live memory-retrieval-status memory-retrieval-rebuild memory-retrieval-query verify-memory-retrieval-observatory verify-semantic-memory-chat-context
