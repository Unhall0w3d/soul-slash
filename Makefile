...
.PHONY: help defaults-show supported-stack-check check setup setup-llamacpp setup-ollama setup-music music-check music-pilot-plan music-model-download music-pilot-run music-vulkan-check music-vulkan-setup-plan music-vulkan-setup music-vulkan-download-plan music-vulkan-download music-vulkan-run-plan music-vulkan-run verify-music-core-vulkan visual-check visual-runtime-plan visual-runtime-install visual-model-download-plan visual-model-download visual-motion-check visual-motion-runtime-plan visual-motion-runtime-install visual-motion-model-download-plan visual-motion-model-download visual-motion-pilot-plan visual-motion-pilot-run visual-native-check visual-native-runtime-plan visual-native-runtime-install visual-native-model-download-plan visual-native-model-download verify-visual-motion-qualification verify-visual-native-video blender-visual-check blender-visual-plan blender-visual-run verify-blender-visual-a0 music-transcription-plan music-transcription-install voice-transcription-check voice-transcription-plan voice-transcription-install verify-voice-transcription voice-synthesis-check voice-synthesis-plan voice-synthesis-install voice-synthesis-audition verify-voice-synthesis notification-audio-build verify-notification-cues verify-project-timeline verify-chat-progress-summaries verify-storage-retention-census verify-backup-manifest-reconciliation backup-config-plan backup-configure verify-backup-administration verify-nightly-drs-transaction music-reference-tooling-check music-reference-tooling-plan music-reference-tooling-install music-reference-enrichment-check music-reference-enrichment-plan music-reference-enrichment-install music-projects music-resources music-project-create music-project-inspect music-generate-preview music-generate-execute music-cancel-preview music-cancel-execute verify-music-a2 verify-music-vocal-analysis verify-music-references verify-music-reference-analysis verify-music-reference-synthesis verify-music-lite-edit verify-music-publication-package verify-youtube-authenticated-upload verify-youtube-dashboard-upload verify-youtube-description-sync verify-character-identity knowledge-vault-status knowledge-vault-search knowledge-vault-init-preview knowledge-vault-init knowledge-vault-memory-export-preview knowledge-vault-memory-export knowledge-vault-memory-import-preview knowledge-vault-memory-import knowledge-vault-reflection-preview knowledge-vault-reflection-execute verify-knowledge-vault verify-knowledge-reflection local-search local-search-core-eval verify-local-search detect test-runtime test-fast test-think test-soul doctor env-show download-model start-llamacpp foreground-llamacpp dashboard dashboard-reset-admin dashboard-service-plan dashboard-service-install dashboard-service-status dashboard-service-logs dashboard-service-uninstall verify-web-knowledge verify-model-runtime-controls model-runtime-amd-plan model-runtime-amd-install model-runtime-amd-status model-runtime-amd-uninstall model-runtime-gemma-plan model-runtime-gemma-install model-runtime-gemma-status model-runtime-gemma-uninstall model-runtime-startup-plan model-runtime-startup-install model-runtime-startup-status model-runtime-startup-uninstall model-runtime-startup-reconcile model-runtime-identity-plan model-runtime-identity-execute private-memory-plan private-memory-execute verify-private-memory clean-runtime chmod-scripts fix-mtimes verify-maintenance-foreground-execution verify-maintenance-desktop-handoff maintenance-handoff-check maintenance-handoff-plan maintenance-handoff-install
.PHONY: help defaults-show supported-stack-check check setup setup-llamacpp setup-ollama setup-music music-check music-pilot-plan music-model-download music-pilot-run music-vulkan-check music-vulkan-setup-plan music-vulkan-setup music-vulkan-download-plan music-vulkan-download music-vulkan-run-plan music-vulkan-run verify-music-core-vulkan visual-check visual-runtime-plan visual-runtime-install visual-model-download-plan visual-model-download visual-motion-check visual-motion-runtime-plan visual-motion-runtime-install visual-motion-model-download-plan visual-motion-model-download visual-motion-pilot-plan visual-motion-pilot-run visual-native-check visual-native-runtime-plan visual-native-runtime-install visual-native-model-download-plan visual-native-model-download verify-visual-motion-qualification verify-visual-native-video music-transcription-plan music-transcription-install voice-transcription-check voice-transcription-plan voice-transcription-install verify-voice-transcription voice-synthesis-check voice-synthesis-plan voice-synthesis-install voice-synthesis-audition verify-voice-synthesis notification-audio-build verify-notification-cues verify-project-timeline verify-chat-progress-summaries verify-storage-retention-census verify-backup-manifest-reconciliation backup-config-plan backup-configure verify-backup-administration verify-nightly-drs-transaction verify-nightly-drs-automation drs-credential-plan drs-credential-enroll drs-test-plan drs-test-install drs-automation-status drs-permanent-plan drs-permanent-install music-reference-tooling-check music-reference-tooling-plan music-reference-tooling-install music-reference-enrichment-check music-reference-enrichment-plan music-reference-enrichment-install music-projects music-resources music-project-create music-project-inspect music-generate-preview music-generate-execute music-cancel-preview music-cancel-execute verify-music-a2 verify-music-vocal-analysis verify-music-references verify-music-reference-analysis verify-music-reference-synthesis verify-music-lite-edit verify-music-publication-package verify-youtube-authenticated-upload verify-youtube-description-sync verify-character-identity knowledge-vault-status knowledge-vault-search knowledge-vault-init-preview knowledge-vault-init knowledge-vault-memory-export-preview knowledge-vault-memory-export knowledge-vault-memory-import-preview knowledge-vault-memory-import knowledge-vault-reflection-preview knowledge-vault-reflection-execute verify-knowledge-vault verify-knowledge-reflection local-search local-search-core-eval verify-local-search detect test-runtime test-fast test-think test-soul doctor env-show download-model start-llamacpp foreground-llamacpp dashboard dashboard-reset-admin dashboard-service-plan dashboard-service-install dashboard-service-status dashboard-service-logs dashboard-service-uninstall verify-web-knowledge verify-model-runtime-controls model-runtime-amd-plan model-runtime-amd-install model-runtime-amd-status model-runtime-amd-uninstall model-runtime-gemma-plan model-runtime-gemma-install model-runtime-gemma-status model-runtime-gemma-uninstall model-runtime-startup-plan model-runtime-startup-install model-runtime-startup-status model-runtime-startup-uninstall model-runtime-startup-reconcile model-runtime-identity-plan model-runtime-identity-execute private-memory-plan private-memory-execute verify-private-memory clean-runtime chmod-scripts fix-mtimes verify-maintenance-foreground-execution verify-maintenance-desktop-handoff maintenance-handoff-check maintenance-handoff-plan maintenance-handoff-install
.PHONY: verify-maintenance-reboot-restore verify-maintenance-passwordless-authority verify-maintenance-aur-review-gate maintenance-authority-plan maintenance-authority-status maintenance-authority-install maintenance-authority-uninstall verify-maintenance-fleet-status verify-maintenance-local-topology verify-wazuh-security-status verify-wazuh-alert-evidence verify-wazuh-alert-notifications verify-wazuh-alert-notification-deployment verify-wazuh-compliance-posture verify-wazuh-conversation-status wazuh-alert-notifications-plan wazuh-alert-notifications-install wazuh-alert-notifications-status wazuh-alert-notifications-uninstall verify-winboat-inventory verify-managed-switch-snmp-inventory lattice-snmp-check loom-snmp-check verify-maintenance-device-control verify-maintenance-fleet-discovery verify-maintenance-fleet-dhcp-identity verify-apple-mobile-fleet-inventory apple-mobile-inventory-check verify-crucible-fedora-status verify-crucible-maintenance-control verify-nixos-maintenance crucible-maintenance-authority-plan crucible-maintenance-authority-status crucible-maintenance-authority-install witness-maintenance-authority-plan witness-maintenance-authority-status witness-maintenance-authority-install verify-witness-maintenance-control fleet-discovery-check fleet-discovery-scan maintenance-resume-plan maintenance-resume-install maintenance-resume-status maintenance-resume-uninstall fleet-status-schedule-plan fleet-status-schedule-install fleet-status-schedule-status fleet-status-schedule-uninstall
...
> @echo
> @echo "Common targets:"
> @echo "  make check             Normalize tracked script modes, then check local tools"
> @echo "  make detect            Detect runtime binaries, endpoints, .env, and local models"
> @echo "  make setup             Normalize tracked script modes, detect, and guide setup"
...
> @echo "  make visual-motion-check  Inspect supported bounded Wan 2.2 image-guided motion"
> @echo "  make visual-motion-runtime-plan  Preview its pinned Vulkan build"
> @echo "  make visual-motion-model-download-plan  Preview exact Wan 2.2 model bytes"
> @echo "  make visual-motion-pilot-plan VISUAL_MOTION_INPUT=/path/request.json  Preview one bounded image-guided render"
...
> @echo "  make blender-visual-check  Inspect the optional bounded Blender Scene candidate"
> @echo "  make blender-visual-plan  Preview one exact Blender A0 EEVEE qualification"
...
> @echo "  make memory-projection-preview  Preview the exact dual-store projection generation"
> @echo "  make memory-projection-execute CONFIRM=REBUILD_MEMORY_PROJECTION EXPECTED_DIGEST=...  Populate, verify, and activate the reviewed generation"
> @echo "  make memory-projection-query MEMORY_QUERY='...'  Run one bounded read-only remote-projection diagnostic query"
> @echo "  make memory-projection-qualify  Compare local and projection retrieval on the owner-private A24 corpus"
> @echo "  make memory-projection-hybrid-qualify  Compare fixed local-dominant hybrid profiles from a content-free A24 envelope"
> @echo "  make memory-retrieval-policy-status  Inspect the active owner-private retrieval policy"
> @echo "  make memory-production-qualify  Run the active production route against the private reviewed corpus"
> @echo "  make memory-consolidate-exact-preview  Inspect one bounded exact-duplicate consolidation candidate"
> @echo "  make memory-consolidate-exact-run REQUEST_ID=...  Consolidate one exact ordinary duplicate"
> @echo "  make memory-reviewed-ledger-preview  Preview fixed reviewed-source projection into canonical memory"
> @echo "  make memory-reviewed-ledger-execute MEMORY_CONFIRMATION=... MEMORY_EXPECTED_DIGEST=...  Execute the exact reviewed projection"
> @echo "  make verify-memory-retrieval-observatory  Verify retrieval, fallback, facade, and Dashboard boundaries"
> @echo "  make verify-semantic-memory-chat-context  Verify fresh semantic recall in ordinary Chat context"
> @echo "  make verify-memory-runtime-private-review  Verify bounded runtime evidence and supervised private retrieval review"
> @echo "  make memory-embedding-runtime-plan  Preview the exact inactive 1024-token embedding unit"
> @echo "  make memory-embedding-runtime-install  Install the reviewed inactive embedding unit"
> @echo "  make memory-embedding-runtime-status  Inspect the exact embedding unit"
> @echo "  make verify-memory-embedding-core-lifecycle  Verify Core-aware semantic runtime lifecycle"
> @echo "  make verify-memory-audit-reconstruction  Verify audit adoption, integrity, reconstruction, and compensation"
> @echo "  make verify-memory-conversation-observation-capture  Verify automatic local source-observation capture"
> @echo "  make verify-memory-observation-derivation  Verify bounded local observation-to-proposal derivation"
> @echo "  make verify-memory-lifecycle-admission   Verify deterministic audited proposal admission"
> @echo "  make verify-memory-live-qualification   Verify supervised capture-to-compensation qualification"
> @echo "  make verify-memory-historical-chat-backfill  Verify bounded historical source reconciliation"
...
> @echo "  make drs-test-plan RUN_AT=ISO8601; make drs-test-install RUN_AT=... EXPECTED_DIGEST=... CONFIRM=INSTALL_SOUL_DRS_QUALIFICATION_TIMER"
> @echo "  make drs-permanent-plan; make drs-permanent-install EXPECTED_DIGEST=... CONFIRM=ACTIVATE_SOUL_DRS_3AM_TIMER"
> @echo "  make verify-crucible-backup-replication  Verify bounded off-device initialize/copy/check gates"
> @echo "  make backup-credential-rotation-plan  Preview the fixed local + Crucible rotation scope"
> @echo "  make backup-credential-rotate  Rotate both repository passwords in a local terminal"
> @echo "  make verify-backup-credential-rotation  Test secure transport, verification, and rollback"
...
> @echo "  make verify-long-form-mix  Test immutable mix plans and portable editor handoff"
> @echo "  make verify-long-form-mix-render  Test bounded listening candidates from immutable mix plans"
> @echo "  make verify-long-form-mix-finalization  Test human-reviewed accepted audio mix exports"
...
> @echo "  make verify-youtube-dashboard-upload  Test Music Studio OAuth and upload controls without Google"
...
> @echo "  make verify-maintenance-local-topology  Verify local topology tab routing, snapshot loading, and shared rendering"
...
> @echo "  make witness-maintenance-authority-plan"
> @echo "  make witness-maintenance-authority-status"
> @echo "  make witness-maintenance-authority-install EXPECTED_DIGEST=... CONFIRM=INSTALL_WITNESS_MAINTENANCE_AUTHORITY"
> @echo "  make verify-witness-maintenance-control"
...
> @echo "  make verify-dev-review-bounded-jobs"
...
supported-stack-check: check music-vulkan-check visual-check visual-motion-check visual-native-check blender-visual-check
...
> @ruby scripts/soul-blender-visual-runtime check --manifest "$(BLENDER_VISUAL_MANIFEST)" --root "$(BLENDER_VISUAL_ROOT)" $(if $(BLENDER_BINARY),--blender "$(BLENDER_BINARY)",)

blender-visual-plan:
> @ruby scripts/soul-blender-visual-runtime plan --manifest "$(BLENDER_VISUAL_MANIFEST)" --root "$(BLENDER_VISUAL_ROOT)" $(if $(BLENDER_BINARY),--blender "$(BLENDER_BINARY)",)

blender-visual-run:
> @test -n "$(EXPECTED_DIGEST)" || { echo "Run blender-visual-plan first, then provide its EXPECTED_DIGEST."; exit 2; }
> @test "$(CONFIRM)" = "RUN_BLENDER_VISUAL_A0" || { echo "Exact confirmation RUN_BLENDER_VISUAL_A0 is required."; exit 2; }
> @ruby scripts/soul-blender-visual-runtime run --manifest "$(BLENDER_VISUAL_MANIFEST)" --root "$(BLENDER_VISUAL_ROOT)" $(if $(BLENDER_BINARY),--blender "$(BLENDER_BINARY)",) --expected-digest "$(EXPECTED_DIGEST)" --confirmation "$(CONFIRM)"
...
verify-blender-scene-a2:
> @ruby scripts/verify-blender-scene-a2.rb

verify-blender-scene-a3:
> @ruby scripts/verify-blender-scene-a3.rb

verify-blender-scene-a4:
> @ruby scripts/verify-music-visual-companion.rb
> @ruby scripts/verify-music-publication-package.rb

verify-blender-scene-a5:
...
verify-blender-scene-a7:
> @ruby scripts/verify-blender-scene-a7.rb
...
verify-youtube-dashboard-upload:
...
verify-storage-retention-census:
> @ruby scripts/verify-storage-retention-backup-census-a2.rb

verify-storage-cleanup:
> @ruby scripts/verify-bounded-storage-cleanup-a3.rb

verify-backup-manifest-reconciliation:
...
verify-nightly-drs-transaction:
> @ruby scripts/verify-nightly-drs-transaction-a1.rb

verify-nightly-drs-automation:
> @ruby scripts/verify-nightly-drs-automation-a2-a3.rb

drs-credential-plan:
> @ruby scripts/soul-nightly-drs-schedule credential-plan

drs-credential-enroll:
> @ruby scripts/soul-nightly-drs-schedule credential-enroll --confirmation "$(CONFIRM)"

drs-test-plan:
> @ruby scripts/soul-nightly-drs-schedule test-plan --run-at "$(RUN_AT)"

drs-test-install:
> @ruby scripts/soul-nightly-drs-schedule test-install --run-at "$(RUN_AT)" --expected-digest "$(EXPECTED_DIGEST)" --confirmation "$(CONFIRM)"

drs-automation-status:
> @ruby scripts/soul-nightly-drs-schedule status

drs-permanent-plan:
> @ruby scripts/soul-nightly-drs-schedule permanent-plan
...
.PHONY: backup-credential-rotation-plan backup-credential-rotate verify-backup-credential-rotation
backup-credential-rotation-plan:
> @ruby scripts/soul-backup-credential-rotation plan

backup-credential-rotate:
> @ruby scripts/soul-backup-credential-rotation rotate

verify-backup-credential-rotation:
> @ruby scripts/verify-backup-credential-rotation-a0.rb
...
memory-reviewed-ledger-preview:
> @ruby scripts/memory-reviewed-ledger-bootstrap.rb preview

memory-reviewed-ledger-execute:
> @test -n "$(MEMORY_CONFIRMATION)" || { echo "MEMORY_CONFIRMATION is required."; exit 2; }
> @test -n "$(MEMORY_EXPECTED_DIGEST)" || { echo "MEMORY_EXPECTED_DIGEST is required."; exit 2; }
> @ruby scripts/memory-reviewed-ledger-bootstrap.rb execute "$(MEMORY_CONFIRMATION)" "$(MEMORY_EXPECTED_DIGEST)"
...
verify-semantic-memory-chat-context:
> @ruby scripts/verify-semantic-memory-chat-context-a3.rb

verify-memory-runtime-private-review:
...
verify-memory-reviewed-ledger-bootstrap:
> @ruby scripts/verify-memory-reviewed-ledger-bootstrap-a6.rb

memory-embedding-runtime-plan:
> @SOUL_OLLAMA_EXPECTED_SHA256="$(OLLAMA_SHA256)" ruby scripts/soul-memory-embedding-runtime plan

memory-embedding-runtime-install:
> @SOUL_OLLAMA_EXPECTED_SHA256="$(OLLAMA_SHA256)" ruby scripts/soul-memory-embedding-runtime install --confirmation "$(CONFIRM)"

memory-embedding-runtime-status:
> @ruby scripts/soul-memory-embedding-runtime status

verify-memory-embedding-core-lifecycle:
> @ruby scripts/verify-memory-embedding-core-lifecycle-a7.rb

verify-memory-audit-reconstruction:
> @ruby scripts/verify-memory-audit-reconstruction-a10.rb

verify-memory-conversation-observation-capture:
> @ruby scripts/verify-memory-conversation-observation-capture-a11.rb

verify-memory-observation-derivation:
> @ruby scripts/verify-memory-observation-derivation-a12.rb

verify-memory-lifecycle-admission:
> @ruby scripts/verify-memory-lifecycle-admission-a13.rb

memory-live-status:
> @ruby scripts/soul-memory-live-qualification status

memory-live-derive:
> @ruby scripts/soul-memory-live-qualification derive "$(MEMORY_REQUEST_ID)"

memory-live-admit:
> @ruby scripts/soul-memory-live-qualification admit "$(MEMORY_REQUEST_ID)"

memory-live-retrieve:
> @ruby scripts/soul-memory-live-qualification retrieve "$(MEMORY_QUERY)"

memory-live-rollback:
> @ruby scripts/soul-memory-live-qualification rollback "$(MEMORY_TRANSACTION_ID)"

verify-memory-live-qualification:
> @ruby scripts/verify-memory-live-qualification-a14.rb

memory-backfill-preview:
> @ruby scripts/soul-memory-historical-backfill preview

memory-backfill-execute:
> @ruby scripts/soul-memory-historical-backfill execute "$(MEMORY_CONFIRMATION)" "$(MEMORY_EXPECTED_DIGEST)"

verify-memory-historical-chat-backfill:
> @ruby scripts/verify-memory-historical-chat-backfill-a15.rb

memory-lifecycle-cycle:
> @test -n "$(MEMORY_REQUEST_ID)" || { echo "MEMORY_REQUEST_ID is required."; exit 2; }
> @ruby scripts/soul-memory-lifecycle-cycle "$(MEMORY_REQUEST_ID)"

verify-memory-autonomous-lifecycle:
> @ruby scripts/verify-memory-autonomous-lifecycle-a16.rb

memory-lifecycle-worker-run:
> @ruby scripts/soul-memory-lifecycle-worker run

memory-lifecycle-worker-status:
> @ruby scripts/soul-memory-lifecycle-worker status

memory-lifecycle-worker-plan:
> @ruby scripts/soul-memory-lifecycle-worker plan

memory-lifecycle-worker-install:
> @ruby scripts/soul-memory-lifecycle-worker install "$(CONFIRM)" "$(EXPECTED_DIGEST)"

memory-lifecycle-worker-deployment-status:
> @ruby scripts/soul-memory-lifecycle-worker deployment-status

memory-lifecycle-worker-uninstall:
> @ruby scripts/soul-memory-lifecycle-worker uninstall "$(CONFIRM)"

verify-memory-core-aware-worker:
> @ruby scripts/verify-memory-core-aware-worker-a17.rb

verify-memory-rebuildable-projection:
> @ruby scripts/verify-memory-rebuildable-projection-a18.rb

verify-memory-projection-deployment:
> @ruby scripts/verify-memory-projection-deployment-a19.rb

verify-memory-projection-reconciliation:
> @ruby scripts/verify-memory-projection-reconciliation-a21.rb

memory-projection-preview:
> @ruby scripts/soul-memory-projection-reconcile preview

memory-projection-execute:
> @ruby scripts/soul-memory-projection-reconcile execute "$(CONFIRM)" "$(EXPECTED_DIGEST)"

verify-memory-projection-transport:
> @ruby scripts/verify-memory-projection-transport-a22.rb

memory-projection-query:
> @test -n "$(MEMORY_QUERY)" || { echo "MEMORY_QUERY is required."; exit 2; }
> @ruby scripts/soul-memory-projection-query "$(MEMORY_QUERY)" "$(or $(MEMORY_LIMIT),8)"

memory-projection-qualify:
> @ruby scripts/soul-memory-projection-qualify

verify-memory-projection-query:
> @ruby scripts/verify-memory-projection-query-a23.rb

verify-memory-projection-qualification:
> @ruby scripts/verify-memory-projection-qualification-a24.rb

memory-projection-hybrid-qualify:
> @ruby scripts/soul-memory-projection-hybrid-qualify "$(or $(A24_ENVELOPE),$(PROJECT_ROOT)/Soul/private/memory/projection/qualification-result.json)"

verify-memory-projection-hybrid-qualification:
> @ruby scripts/verify-memory-projection-hybrid-qualification-a25.rb

memory-retrieval-policy-status:
> @ruby scripts/soul-memory-retrieval-policy status

verify-memory-retrieval-policy:
> @ruby scripts/verify-memory-retrieval-policy-a26.rb

verify-memory-fusion-chat-voice:
> @ruby scripts/verify-memory-fusion-chat-voice-a27.rb

verify-memory-observatory-3d:
> @ruby scripts/verify-memory-observatory-3d-a28.rb

verify-memory-observatory-starmap:
> @ruby scripts/verify-memory-observatory-starmap-a32.rb

memory-production-qualify:
> @ruby scripts/soul-memory-production-qualify

verify-memory-production-qualification:
> @ruby scripts/verify-memory-production-qualification-a29.rb

verify-memory-production-closure:
...
verify-memory-automatic-projection-reconciliation:
> @ruby scripts/verify-memory-automatic-projection-reconciliation-a33.rb

memory-projection-reconciliation-cancel-preview:
> @ruby scripts/soul-memory-projection-reconciliation-request cancel-preview

memory-projection-reconciliation-cancel:
> @ruby scripts/soul-memory-projection-reconciliation-request cancel "$(CONFIRM)" "$(EXPECTED_DIGEST)"

memory-consolidate-exact-preview:
> @ruby scripts/soul-memory-consolidate-exact preview

memory-consolidate-exact-run:
> @ruby scripts/soul-memory-consolidate-exact run "$(REQUEST_ID)"

verify-core-transition-settlement:
> @ruby scripts/verify-core-transition-settlement-a8.rb
...
verify-dev-worker-vault-skill:
> @ruby scripts/verify-dev-worker-vault-skill-a6.rb
...
verify-dev-review-bounded-jobs:
...
verify-long-form-mix:
> @ruby scripts/verify-long-form-mix-a0.rb

verify-long-form-mix-render:
> @ruby scripts/verify-long-form-mix-render-a1.rb

verify-long-form-mix-finalization:
> @ruby scripts/verify-long-form-mix-finalization-a2.rb
...
verify-maintenance-aur-review-gate:
> @ruby scripts/verify-maintenance-aur-review-gate-a11.rb
...
verify-wazuh-security-status:
> @ruby scripts/verify-wazuh-security-status-a4a.rb

verify-wazuh-alert-evidence:
> @ruby scripts/verify-wazuh-alert-evidence-a4b.rb

verify-wazuh-alert-notifications:
> @ruby scripts/verify-wazuh-alert-notifications-a4c.rb

verify-wazuh-alert-notification-deployment:
> @ruby scripts/verify-wazuh-alert-notification-deployment-a4c.rb

verify-wazuh-compliance-posture:
> @ruby scripts/verify-wazuh-compliance-posture-a4d.rb
...
wazuh-alert-notifications-install:
> @test -n "$(WAZUH_ALERTS_INTEGRATION_FILE)" || { echo "WAZUH_ALERTS_INTEGRATION_FILE is required."; exit 2; }
> @test "$(CONFIRM)" = "INSTALL_SOUL_WAZUH_ALERT_NOTIFICATIONS" || { echo "Exact confirmation INSTALL_SOUL_WAZUH_ALERT_NOTIFICATIONS is required."; exit 2; }
> @ruby scripts/soul-wazuh-alert-notifications install --integration-file "$(WAZUH_ALERTS_INTEGRATION_FILE)" --confirmation "$(CONFIRM)"

wazuh-alert-notifications-status:
> @test -n "$(WAZUH_ALERTS_INTEGRATION_FILE)" || { echo "WAZUH_ALERTS_INTEGRATION_FILE is required."; exit 2; }
> @ruby scripts/soul-wazuh-alert-notifications status --integration-file "$(WAZUH_ALERTS_INTEGRATION_FILE)"

wazuh-alert-notifications-uninstall:
> @test -n "$(WAZUH_ALERTS_INTEGRATION_FILE)" || { echo "WAZUH_ALERTS_INTEGRATION_FILE is required."; exit 2; }
> @test "$(CONFIRM)" = "REMOVE_SOUL_WAZUH_ALERT_NOTIFICATIONS" || { echo "Exact confirmation REMOVE_SOUL_WAZUH_ALERT_NOTIFICATIONS is required."; exit 2; }
> @ruby scripts/soul-wazuh-alert-notifications uninstall --integration-file "$(WAZUH_ALERTS_INTEGRATION_FILE)" --confirmation "$(CONFIRM)"

verify-winboat-inventory:
> @ruby scripts/verify-winboat-inventory-a1.rb
...
loom-snmp-check:
> @ruby scripts/soul-loom-snmp-check
...
verify-nixos-maintenance:
> @ruby scripts/verify-nixos-maintenance-a1.rb

verify-witness-maintenance-control:
> @ruby scripts/verify-witness-maintenance-control-a1.rb

verify-generic-debian-apt-maintenance:
> @ruby scripts/verify-generic-debian-apt-maintenance-a1.rb
...
witness-maintenance-authority-plan:
> @ruby scripts/soul-witness-maintenance-authority plan

witness-maintenance-authority-status:
> @ruby scripts/soul-witness-maintenance-authority status

witness-maintenance-authority-install:
> @test -n "$(EXPECTED_DIGEST)" || { echo "Run witness-maintenance-authority-plan first, then provide EXPECTED_DIGEST."; exit 2; }
> @test "$(CONFIRM)" = "INSTALL_WITNESS_MAINTENANCE_AUTHORITY" || { echo "Exact confirmation INSTALL_WITNESS_MAINTENANCE_AUTHORITY is required."; exit 2; }
> @ruby scripts/soul-witness-maintenance-authority install --expected-digest "$(EXPECTED_DIGEST)" --confirmation "$(CONFIRM)"

verify-maintenance-device-control:
> @ruby scripts/verify-maintenance-device-control-c1.rb

verify-host-stewardship-file-steward:
> @ruby scripts/verify-host-stewardship-file-steward-a0-a2.rb

verify-software-storage-steward:
> @ruby scripts/verify-software-storage-steward-a0-a1.rb

verify-incident-narrator:
> @ruby scripts/verify-incident-narrator-a0.rb

verify-patchmon-concept-adaptation:
> @ruby scripts/verify-patchmon-concept-adaptation-a0.rb

verify-fleet-observability:
> @ruby scripts/verify-fleet-observability-a0.rb

verify-fleet-observability-a1:
> @ruby scripts/verify-fleet-observability-a1.rb

verify-fleet-observability-a1-1:
> @ruby scripts/verify-fleet-observability-a1-1.rb

verify-fleet-observability-a2:
> @ruby scripts/verify-fleet-observability-a2.rb
...
verify-fundamental-network-diagnose:
> @ruby scripts/verify-fundamental-network-diagnose-a1.rb

verify-fundamental-repository-inspect:
> @ruby scripts/verify-fundamental-repository-inspect-a1.rb
