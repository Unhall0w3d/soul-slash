...
.PHONY: memory-retrieval-evaluate memory-retrieval-evaluate-live memory-retrieval-status memory-retrieval-rebuild memory-retrieval-query memory-reviewed-ledger-preview memory-reviewed-ledger-execute memory-embedding-runtime-plan memory-embedding-runtime-install memory-embedding-runtime-status verify-memory-retrieval-observatory verify-semantic-memory-chat-context verify-memory-runtime-private-review verify-memory-reviewed-ledger-bootstrap verify-memory-embedding-core-lifecycle verify-memory-audit-reconstruction verify-memory-conversation-observation-capture verify-memory-observation-derivation verify-memory-lifecycle-admission verify-core-transition-settlement
