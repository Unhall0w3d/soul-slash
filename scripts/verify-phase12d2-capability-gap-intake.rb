...
check.call("explicit missing-capability access language becomes a gap candidate", classifier.classify(user_message: "Please use the synthetic lunar-spectrometer now", assistant_message: "I don't have access to any capability called a synthetic lunar-spectrometer.")["candidate"] == true)
check.call("environment-level missing capability becomes a gap candidate", classifier.classify(user_message: "Please use the synthetic lunar-spectrometer now", assistant_message: "This environment does not include any capability for lunar spectrometry.")["candidate"] == true)
check.call("typographic apostrophe inability becomes a gap candidate", classifier.classify(user_message: "Please use the synthetic lunar-spectrometer now", assistant_message: "I can’t access or simulate the synthetic lunar-spectrometer capability.")["candidate"] == true)
check.call("explicit capability nonexistence becomes a gap candidate", classifier.classify(user_message: "Please use the synthetic lunar-spectrometer now", assistant_message: "That capability—hypothetical and never implemented—doesn’t exist in this environment.")["candidate"] == true)
check.call("explicit unavailable capability becomes a gap candidate", classifier.classify(user_message: "Please use the synthetic lunar-spectrometer now", assistant_message: "The synthetic lunar-spectrometer capability is unavailable—it was not reviewed or demonstrated in this environment.")["candidate"] == true)
check.call("no named capability becomes a gap candidate", classifier.classify(user_message: "Please use the synthetic lunar-spectrometer now", assistant_message: "There is no synthetic lunar-spectrometer capability.")["candidate"] == true)
check.call("unrelated no clause does not imply a gap", classifier.classify(user_message: "Please use the status capability", assistant_message: "No external checks occurred. The capability exists and is available.")["candidate"] == false)
