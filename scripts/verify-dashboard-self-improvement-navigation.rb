...
check.call("bootstrap advertises primary and nested surfaces separately", facade.include?('"product_tabs" => ["Chat", "Self Improvement", "Creative Studios", "Administration"]') && facade.include?('"self_improvement_surfaces" => ["Skill Studio", "Self Assessment", "Self Augmentation"]') && facade.include?('"creative_surfaces" => ["Music Studio", "Visual Studio", "Mix Studio"]') && facade.include?('"administration_surfaces" => ["Project Timeline", "Local Topology", "Backup & Recovery", "Guided Maintenance"]'))
check.call(
