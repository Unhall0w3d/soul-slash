...
check.call("Music Studio exposes exact whole-second entry with bounded range guidance", html.include?('id="music-duration" type="number" min="30" max="600" step="1"') && html.include?("Exact 30–300 seconds, or 600 seconds.") && js.include?("supportedMusicDuration"))
