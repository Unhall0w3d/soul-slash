...
check("server protects facade and rotates sessions", http_source.include?("authentication_required") && http_source.include?("password_change_required") && auth_source.include?("@sessions.clear") && auth_source.include?("PBKDF2_ITERATIONS = 600_000"), errors)
