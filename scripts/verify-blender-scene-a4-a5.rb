...
expected = %w[abstract liminal architectural audio_reactive bioluminescent_grove]
check.call("A5 template catalog is closed and complete", templates.fetch("templates").keys.sort == expected.sort)
